...
function setAllSort() {
        ...
        if (!step.toDelete) {
            ...
            for (var j = 0; j < actions.length; j++) {
                ...
                if (!action.toDelete) {
                    ...
                    setItemsSortAttribute(controlArr);
            ...
            setItemsSortAttribute(actionArr);
    ...
    setItemsSortAttribute(stepArr);

    return stepArr;
}

/**
 * Used to set the sort attribute of step, action or control
 * @param array
 */
function setItemsSortAttribute(array) {
